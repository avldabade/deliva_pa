                                                    ...
                                                    children: <Widget>[
                                                      SizedBox(
                                                        ...
                                                        child: CountryCodePicker(
                                                          ...
                                                          //alignLeft: true,
                                                          //textStyle: TextStyle(fontSize: 18.0, color: Color(ColorValues.black)),
                                                  ...
                                                  Stack(
                                                    children: <Widget>[
                                                      Padding(
                                                        ...
                                                        child: new Container(
                                                          height: 1.0,
                                                          color: hasError && _autoValidate ?Color(ColorValues.error_red) :Colors.grey,
                                                        ),
                                                      ),
                                                      Visibility(
                                                        child: Align(
                                                      ...
                                                      hasError && _autoValidate ? Positioned(
                                                        right: 0.0,
                                                        bottom: 0.0,
                                                        top: 1.0,
...
//    If all data are not valid then start auto validation.
  ...
  void _validateInputs() {
    _autoValidate=true;
    print('mobileNoController.text::: ${mobileNoController.text}');
    String msg = Validation.validateMobile(
...
//http://103.76.253.133:8751/userauth/oauth/token?grant_type=password&username=1234567890&password=ZHVtbXkxMjM=&countryCode=91&roleId=2
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("statusCode error....");
        Toast.show("Not Registred", context,
            duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      }
    } on SocketException catch (e) {
      print('error caught: $e');
