...
class PackageDetail extends StatefulWidget {
  ...
  PackageDetail(this.title, this.requestId, this.status, {Key key})
      : super(key: key);
...
class _PackageDetailState extends State<PackageDetail> {
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Image(
                                                image: new AssetImage(
                                                    "assets/images/cancel_request.png"),
  ...
  Future _navigateToVerifyDetails(
    ...
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => VerifyPackageDetail(title, requestId)),
    );
    if (result != null) {
      //refreshPage
