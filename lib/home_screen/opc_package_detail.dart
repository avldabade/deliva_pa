...
import 'opc_deliver_package_to_agent.dart';

class OPCPackageDetail extends StatefulWidget {
  final String status;
  final String title;
  final int requestId;

  OPCPackageDetail(this.title, this.requestId, this.status, {Key key})
      : super(key: key);

  @override
  _OPCPackageDetailState createState() => _OPCPackageDetailState();
}

class _OPCPackageDetailState extends State<OPCPackageDetail> {
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: () async {
                                            ...
                                            __navigateToDeliverToAgent(widget.title,widget.requestId);
                                          },
                                          child: Container(
                                            //width: 100.0,
                                            height: 50.0,
  ...
  Future __navigateToDeliverToAgent(
      String title,
      int requestId
      ) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => OPCDeliverPackageToAgent(title, requestId,widget.status)),
    );
  }
