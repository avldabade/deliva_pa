...
class OperationPageNew extends StatefulWidget {
  @override
  OperationPageNewState createState() => OperationPageNewState();
}

class OperationPageNewState extends State<OperationPageNew> {
  ...
  void saveOperational() async {
    ...
    String dataURL = Constants.BASE_URL + Constants.SAVE_OPERATON + "$userId";
